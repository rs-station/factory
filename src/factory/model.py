...
class Settings():
    ...
    lysozyme_sequence_file_path = "/n/holylabs/LABS/hekstra_lab/Users/fgiehr/factory/lysozyme.seq"
...
class LossSettings():
    ...
    profile_loss_weight: list[float] = dataclasses.field(default_factory=lambda: [0.0001, 0.0001, 0.0001])
    eps: float = 0.00001
...
class Model(L.LightningModule):
    ...
    def __init__(self, settings: Settings, loss_settings: LossSettings):
        ...
        self.distribution_for_shoebox_profile = self.settings.build_shoebox_profile_distribution()
    ...
    def compute_shoebox_profile(self, shoebox_representation, image_representation):
        return self.distribution_for_shoebox_profile.compute_profile(shoebox_representation, image_representation)
